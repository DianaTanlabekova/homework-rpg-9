...
public class Hero {
    ...
    public void restoreFromMemento(HeroMemento memento) {
        ...
        memento.getInventorySnapshot().forEach(restored::addArtifact);
        this.inventory = restored;
    }

    public String status() {
        return String.format("[%s] HP=%d/%d  Mana=%d  Gold=%d  ATK=%d  DEF=%d  Items=%d",
            name, hp, maxHp, mana, gold, attackPower, defense, inventory.size());
    }
